    ...
    <div id="templatemo_main">
        ...
        <div class="col_2 float_l">
        	<h2>Welcome To Philippine Newlong Corp.</h2>
            <br class="cleaner h20" />
            <p><h3>Reliable Technology = Worry-Free Operations</h3></p>
            <div class="col_2 float_cust">
            <p>Technology must always be used for our benefit. If we must rely on it for our day to day operations, machine integrity and dependability are required, supported with reliable customer service anytime, anywhere. At Philippine Newlong Corporation, we guarantee that you can reach us whenever you need to. There is no time zone difference, no language barrier.</p>
         	 <br class="cleaner h20" />
            <p>Every machine you purchase from us comes with the commitment that we will be with you - when you want to upgrade, or when you want a customized fit of your machine to your business operations.</p>
            </div>
        </div>
